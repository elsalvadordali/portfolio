...
<div class="body">
	...
	{:else}
		<article in:fly={{ x: -100 }} out:fly={{ x: 100 }}>
			...
			<p>A current CS student at WGU, I discovered my passion a little later in life, after having gotten my first degree in microbiology. When I’m not coding, you’ll find me trying new vegan recipes from library books, reading, or occasionally water coloring. </p>
			<p>As a developer, I’ve worked alongside a diverse array of both developer and designers that continue to inspire me and raise the standards I hold for myself and for my work. It’s easier to collaborate by writing maintainable code! </p>
			<p>Although my passion is web development, I like to take classes in adjacent fields such as the google UX design course, and CodePath’s iOS course to give me a wider insight into the whole of the development process. </p>
			<h4>My Skills</h4>
			<div class='grid'>
				<p>TypeScript</p>
				<p>CSS</p>
			...
			<p>Are you looking for a developer? Or do you just wanna reach out? Either way, I'd love to connect!</p>

			<a href="mailto:tijano@gmail.com">email me</a> &middot; <a href="https://www.linkedin.com/in/tijaname/">LinkedIn</a> &middot; <a href='/Tijana_Jung.pdf' target="_blank">resume</a>
			</footer>
		</article>
	{/if}
</div>
